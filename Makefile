...
SOURCES += $(wildcard chess-board/*.cc)	
SOURCES += $(wildcard chess-pieces/*.cc)	
SOURCES += $(wildcard controller/*.cc)	
SOURCES += $(wildcard players/*.cc)	
SOURCES += $(wildcard view/*.cc)	
SOURCES += $(wildcard move/*.cc)
